-- New consent version only; preserve previously applied migrations and historical receipts.
-- This does NOT implement retention automation or enable applications.
begin;
...
begin
  ...
  if p_data->>'consent_version' is distinct from '2026-09-07-v1' then raise exception 'Invalid consent version'; end if;
